...
#                 cur.execute("""
#                     SELECT "UserID", "Username", "Role", "ParentID"
#                     FROM "User"
...
#                 user_id, username, role, parent_id = row
...
#                     )
#                     family_members = [dict(zip([d[0] for d in cur.description], row)) for row in cur.fetchall()]
